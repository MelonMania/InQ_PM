...
//  InQ_PM
//
//  Created by RooZin on 2022/02/14.
//
...
class CardTableViewCell: UITableViewCell {
    ...
    /*var project : ProceedingProjectVC.ProjectForApply? {
        didSet {
            if let project = project {
                projectID.text = project.projectName
                detail.text = project.details
                techList.text = project.techList
            }
        }
    }*/
